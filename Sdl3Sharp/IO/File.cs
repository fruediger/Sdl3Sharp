...
public static partial class File
{
	...
	/// <returns><c><see langword="true"/></c>, if all available data from the specified file was succesfully read into native memory managed by the resulting <see cref="NativeMemoryManager"/>; otherwise, <c><see langword="false"/></c></returns>
	/// <remarks>
	/// <para>
	...
	/// <returns><c><see langword="true"/></c>, if the data from the specified <see cref="NativeMemory">memory buffer</see> was succesfully written into the specified file; otherwise, <c><see langword="false"/></c></returns>
	/// <remarks>
	/// <para>
	...
	/// <returns><c><see langword="true"/></c>, if all the data from the specified <see cref="ReadOnlySpan{T}"/> was succesfully written into the specified file; otherwise, <c><see langword="false"/></c></returns>
	/// <remarks>
	/// <para>
	/// This method is not thread safe.
	/// </para>
