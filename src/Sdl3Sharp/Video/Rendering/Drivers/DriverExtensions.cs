...
/// <summary>
/// Provides extension methods and properties for <see cref="IDriver"/> implementing rendering driver types
/// </summary>
public static class DriverExtensions
{
		...
		where TDriver : IDriver
	{
		...
		/// </para>
		/// <para>
		/// This property effectively checks whether or not the name of the rendering driver is present in <see cref="IDriver.AvailableDriverNames"/>.
		/// </para>
		/// </remarks>
		public static bool IsAvailable => Cache<TDriver>.IsAvailable ??= TDriver.Name switch { string name => IDriver.AvailableDriverNames.Contains(name), _ => false };
	}
}
