...
{
	/// <summary>
	/// Provides property names for <see cref="ITexture"/> <see cref="Properties">properties</see>
	/// </summary>
	public abstract class PropertyNames
	{
		/// <summary>
		/// The name of a <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)">property used when creating an <see cref="ITexture"/></see>
		...
		/// This property is required when creating a texture. Although, you don't need to explicitly specify this property if you set the <em>width</em> parameter in a call to the <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)"/> method.
		/// </para>
		/// </remarks>
		...
		///	This property is required when creating a texture. Although, you don't need to explicitly specify this property if you set the <em>height</em> parameter in a call to the <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)"/> method.
		///	</para>
		///	</remarks>
		...
		/// <summary>
		/// The name of a <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)">property used when creating an <see cref="ITexture"/></see>
		/// that holds the palette to use when creating a <see cref="ITexture"/> with a palettized pixel format
		/// </summary>
		/// <remarks>
		/// <para>
		/// This can be set or changed later using the <see cref="Palette"/> property of an <see cref="ITexture"/>.
		/// </para>
		/// </remarks>
		...
		/// <summary>
		/// The name of a <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)">property used when creating an <see cref="ITexture"/></see>
		/// that holds the defining value for 100% diffuse white for HDR10 and floating point <see cref="ITexture"/>s when creating them
		/// </summary>
		/// <remarks>
		/// <para>
		/// For HDR10 and floating point <see cref="ITexture"/>s, the value of the property defines the value of 100% diffuse white that should be used by the newly created texture, with higher values being displayed in the <see cref="HdrHeadroomFloat">High Dynamic Range headroom</see>.
		...
		/// <summary>
		/// The name of a <see cref="IRenderer.TryCreateTexture(out ITexture?, ColorSpace?, PixelFormat?, TextureAccess?, int?, int?, Palette?, float?, float?, Properties?)">property used when creating an <see cref="ITexture"/></see>
		/// that holds the maximum dynamic range for HDR10 and floating point <see cref="ITexture"/>s when creating them
		/// </summary>
		/// <remarks>
		/// <para>
		/// For HDR10 and floating point <see cref="ITexture"/>s, the value of the property defines the maximum dynamic range used by the content of the newly created texture, in terms of the <see cref="CreateSdrWhitePointFloat">SDR white point</see>.
		...
		/// <summary>
		/// The name of a <em>read-only</em> <see cref="Properties">property</see> that holds the defining value for 100% diffuse white for HDR10 and floating point <see cref="ITexture"/>s
		/// </summary>
		/// <remarks>
		/// <para>
		/// For HDR10 and floating point <see cref="ITexture"/>s, the value of the property defines the value of 100% diffuse white, with higher values being displayed in the <see cref="HdrHeadroomFloat">High Dynamic Range headroom</see>.
		/// This defaults to <c>100</c> for HDR10 textures and <c>1.0</c> for other textures.
		/// </para>
		/// </remarks>
		...
		/// <summary>
		/// The name of a <em>read-only</em> <see cref="Properties">property</see> that holds the maximum dynamic range for HDR10 and floating point <see cref="ITexture"/>s
		/// </summary>
		/// <remarks>
		/// <para>
		/// For HDR10 and floating point <see cref="ITexture"/>s, the value of the property defines the maximum dynamic range used by the content, in terms of the <see cref="SdrWhitePointFloat">SDR white point</see>.
		/// If the associated property is defined, any values outside of the range supported by the display will be scaled into the available HDR headroom, otherwise they will be clipped.
