...
{
	/// <summary>
	/// Provides property names for <see cref="Renderer"/> <see cref="Properties">properties</see>
	/// </summary>
	public abstract class PropertyNames
	{
		/// <summary>
		/// The name of a <see cref="Window.TryCreateRenderer(out Renderer?, string?, ColorSpace?, RendererVSync?, Properties?)">property used when creating a <see cref="Renderer"/></see>
