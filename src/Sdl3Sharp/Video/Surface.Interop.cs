...
partial class Surface
{
	...
	/// <param name="rect">The <see cref="https://wiki.libsdl.org/SDL3/SDL_Rect">SDL_Rect</see> structure representing the clipping rectangle, or NULL to disable clipping</param>
	...
	/// </para>
	/// <para>
	/// It is a pixel of the format used by the surface, as generated by <see cref="https://wiki.libsdl.org/SDL3/SDL_MapRGB">SDL_MapRGB</see>().
	/// </para>
	/// </remarks>
