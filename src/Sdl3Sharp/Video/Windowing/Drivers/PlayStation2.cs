...
public sealed partial class PlayStation2 : IWindowingDriver
{
	/// <summary>
	/// The name of the Sony PlayStation 2 windowing driver
	/// </summary>
	/// <remarks>
	/// <para>
	/// The value of this constant is equal to <c>"ps2"</c>.
	/// </para>
	/// </remarks>
	public const string Name = "ps2";
