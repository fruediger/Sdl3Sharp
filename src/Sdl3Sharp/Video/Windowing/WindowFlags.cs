...
/// <summary>
/// Represents flags associated with a <see cref="Window"/>
/// </summary>
[Flags]
public enum WindowFlags : ulong
{
	...
	/// <summary> The <see cref="Window"/> is neither mapped onto the desktop nor shown in the taskbar, dock, or window list; <see cref="Window.TryShow"/> is required for it to become visible</summary>
	...
	FillDocument = 0x0000000000200000ul,
