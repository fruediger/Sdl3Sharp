...
/// </para>
/// <para>
/// You can use the <see cref="TryGetValue(out int)"/>, <see cref="TryGetCentered(out Display?)"/>, and <see cref="TryGetUndefined(out Display?)"/> methods to determine whether a <see cref="WindowPosition"/> represents a definite window coordinate value, a centered position, or an undefined position,
...
#pragma warning restore IDE0290
	...
	public readonly bool TryGetCentered(out Display? display)
	{
		...
		{
			return Display.TryGetOrCreate(unchecked((uint)(mValue & ~mKindMask)), out display);
		}
